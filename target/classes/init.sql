...
COMMENT ON COLUMN customize_project_info.owner_id IS '所有者ID';
COMMENT ON COLUMN customize_project_info.f_bizstate IS '业务状态';
COMMENT ON COLUMN customize_project_info.create_time IS '记录创建时间';
COMMENT ON COLUMN customize_project_info.founder IS '创建人';
COMMENT ON COLUMN customize_project_info.last_time IS '记录修改时间';
COMMENT ON COLUMN customize_project_info.ls_modifier IS '修改人';
...
COMMENT ON COLUMN customize_contract_info.owner_id IS '所有者ID';
COMMENT ON COLUMN customize_contract_info.f_bizstate IS '业务状态';
COMMENT ON COLUMN customize_contract_info.create_time IS '记录创建时间';
COMMENT ON COLUMN customize_contract_info.founder IS '创建人';
COMMENT ON COLUMN customize_contract_info.last_time IS '记录修改时间';
COMMENT ON COLUMN customize_contract_info.ls_modifier IS '修改人';
...
COMMENT ON COLUMN customize_contract_project_ref.owner_id IS '所有者ID';
COMMENT ON COLUMN customize_contract_project_ref.f_bizstate IS '业务状态';
COMMENT ON COLUMN customize_contract_project_ref.create_time IS '记录创建时间';
COMMENT ON COLUMN customize_contract_project_ref.founder IS '创建人';
COMMENT ON COLUMN customize_contract_project_ref.last_time IS '记录修改时间';
COMMENT ON COLUMN customize_contract_project_ref.ls_modifier IS '修改人';
...
COMMENT ON COLUMN customize_boq_main.owner_id IS '所有者ID';
COMMENT ON COLUMN customize_boq_main.f_bizstate IS '业务状态';
COMMENT ON COLUMN customize_boq_main.create_time IS '记录创建时间';
COMMENT ON COLUMN customize_boq_main.founder IS '创建人';
COMMENT ON COLUMN customize_boq_main.last_time IS '记录修改时间';
COMMENT ON COLUMN customize_boq_main.ls_modifier IS '修改人';
...
COMMENT ON COLUMN customize_boq_detail.owner_id IS '所有者ID';
COMMENT ON COLUMN customize_boq_detail.f_bizstate IS '业务状态';
COMMENT ON COLUMN customize_boq_detail.create_time IS '记录创建时间';
COMMENT ON COLUMN customize_boq_detail.founder IS '创建人';
COMMENT ON COLUMN customize_boq_detail.last_time IS '记录修改时间';
COMMENT ON COLUMN customize_boq_detail.ls_modifier IS '修改人';
